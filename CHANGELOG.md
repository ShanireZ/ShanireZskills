...
- Establish Aptinery as a curated foundry and public marketplace for 20 independently installable Agent Skills, with synchronized Agent Plugins, Codex/ChatGPT, Claude Code, GitHub Copilot CLI, and skills CLI distribution.
...
- Remove the obsolete `v0.1.0` Git tag while retaining the corresponding changelog history.
